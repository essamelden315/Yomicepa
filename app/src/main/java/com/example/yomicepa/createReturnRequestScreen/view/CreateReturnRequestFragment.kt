 ...
 * Use the [CreateReturnRequestFragment.newInstance] factory method to
...
class CreateReturnRequestFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CreateReturnRequestFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CreateReturnRequestFragment().apply {
